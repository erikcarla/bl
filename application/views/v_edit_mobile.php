...
Nama:<br />
<input class="input" name="Nama" value="<?php echo $ubah->Nama?>" style="" type="text" id="nama" /><br />
No HP:<br />
<input class="input" name="NoHP" value="<?php echo $ubah->NoHP?>" type="text" id="nohp" /><br />
Kampus:<br />
...
Jadwal:<br />
<select name="JadwalID" class="" id="Jadwal" onChange="bagofholding" >
...
<input type="submit" class="btn btnC" onClick="MM_validateForm('nama','','R','nohp','','RisNum');return document.MM_returnValue" value="UPDATE"/>
<input type="reset" value="RESET" class="btn"/>
</form></div>
<div class="acw apm"></div></div></div></div></div></div><div id="static_templates">
<div id="static_templates_merge">
<a href="<?php echo base_url().'mobile/registrasi';?>">Back</a><br>
