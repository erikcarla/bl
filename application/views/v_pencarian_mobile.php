...
<div class="acw apm" id="title">PENCARIAN </div><div id="body"></div>
<div class="abb acw apm">

<form method="post" action="<?php echo base_url().'mobile/searchdata/';?>">
Masukkan Data :<br />
<input class="input" name="cari" value="<?php echo set_value('Pencarian'); ?>" style="" type="text" id="Pencarian" /><br /><br />
<input name="submit" type="submit" class="btn btnC" onClick="MM_validateForm('Pencarian','','R');return document.MM_returnValue" value="CARI" />
