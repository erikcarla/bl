...
<html xmlns="http://www.w3.org/1999/xhtml"><head><title>TIKET BNCC LAUNCHING</title><style type="text/css">
...
<?php endif; ?>
<?php if($id==0):?>
	<p>Registrasi Gagal, kapasitas penuh</p>
    <a href="<?php echo base_url().'mobile/registrasi';?>">Back</a><br>
<?php elseif($id==-1):?>
	<p>Registrasi Gagal, data sudah ada</p>
    <a href="<?php echo base_url().'mobile/registrasi';?>">Back</a><br>
<?php elseif($id==-2):?>
	<p>Registrasi Waiting List sukses</p>
    <a href="<?php echo base_url().'mobile/registrasi';?>">Back</a><br>
<?php else: ?>
...
<?php echo anchor('mobile/edit/'.$id,'Edit');?><br>
<a href="<?php echo base_url().'mobile/registrasi';?>">Back</a><br>
<br />
</div></div>
<?php endif; ?>
