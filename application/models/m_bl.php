	...
	class M_bl extends CI_Model
	{
		...
		function insert($set)//untuk menu registrasi
		{
			...
			{	
				...
				//jika udah dapet souvenir (tidak di ubah), jika belum dapet souvenir
				if(!isset($set['Souvenir'])){$set['Souvenir']=0;}
				...
				//if($set['JadwalID']==0){$arr['id']=$id;return $arr;}//keluar dengan code -2, sukses daftar tapi tidak ada jadwal
